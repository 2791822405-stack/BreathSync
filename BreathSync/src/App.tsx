...
const INSIGHTS = [
  {
    ...
    color: 'text-blue-500',
    bg: 'bg-blue-500/10',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuArBvKAD-WDq189kI2QI9mFJnH23lc0eG_0IxfXPgfCxb3D8oR1d5ZGZkHGYNWpIFr8rnFCWsoxun8ghEqgYXIX6F4CDb1fKOFWWphAAxvkidvEBLp7ysJOwYcSH73j9CqJVBfxa3aH0QWF7LTVgpLlJKR4hSOgSDpCQx-cTBPS0rG7HaXsFWyTMHhP_JydXWqzrgH_4aYBR9w1zND2QRJvk7Y1-i0kn5zt_ZKowUgTBfRWEvh6_UDvAS2-AxdrNTp7NAmjH52ofuY'
  },
  {
    id: 2,
    title: '治疗效果',
      ...
      <section className="liquid-glass p-9 rounded-[40px] flex flex-col items-center text-center relative overflow-hidden border border-black/[0.03] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.08)]">
        ...
        <div className="relative mb-5">
          <div className="w-28 h-28 rounded-full overflow-hidden border-4 border-white shadow-2xl relative group ring-4 ring-primary/10">
            <img 
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuAbPJ_KpKuuroEjtqJvI0YZrgfIJ-uzQQ4Nd2svQ5LzwOI8G71ioOFbGoxI-uXwkKY7p9JtO8POM1XKkDEs2AdQ0mC-gdA9roJqNemLlrNX909eCocv81RANaZurDmM9s5MXGuce_Rfds5IwbGdVQzGqPoATf3EpB5MNC07oNLhzY4OHKncbV132oRrbQrmxD8dcW1q_GSCub5J4QEAg7rJRGQElL7kYbpKOjdBFlPQziEmahMYOAXanvNN-4llHyuEPx8G6Pd9uQU" 
